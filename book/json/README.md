...
``` file=examples/correct/book.json
{
...
```ocaml file=examples/correct/yojson_basic.mli,part=0
type json = [
...
```ocaml file=examples/correct/yojson_basic.mli,part=1
...
```ocaml file=examples/correct/yojson_basic_simple.mli
...
```sh dir=examples/correct/read_json
...
```ocaml file=examples/correct/list_excerpt.mli,part=0
...
```ocaml file=examples/correct/list_excerpt.mli,part=1
...
```ocaml file=examples/correct/yojson_safe.mli,part=0
type json = [
  | `Assoc of (string * json) list
  | `Bool of bool
  | `Float of float
...
```ocaml file=examples/correct/yojson_safe.mli,part=1
...
``` file=examples/correct/github.atd
type scope = [
    User <json name="user">
...
```ocaml file=examples/correct/github_j_excerpt.mli
